                ...
                <div class="col-lg-5">
                    ...
                    <div class="payment ml-30">
                        ...
                        <div class="payment_option">
                            ...
                            <div class="custome-radio">
                                <input class="form-check-input" required="" type="radio" name="payment_option" value="bkash" id="exampleRadios5" checked="">
                                <label class="form-check-label" for="exampleRadios5" data-bs-toggle="collapse" data-target="#bkash" aria-controls="bkash">bKash</label>
                            </div>
                        </div>
