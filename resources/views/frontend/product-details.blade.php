                        ...
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <div class="detail-extralink mb-50">
                                ...
                                <div class="product-extra-link2">
                                    <button type="submit" class="button button-add-to-cart"><i class="fi-rs-shopping-cart"></i><a href="{{ route('addToCart',$product->id) }}">Add to cart</a></button>
                                    <a aria-label="Add To Wishlist" class="action-btn hover-up" href="{{ route('wishlist.store',$product->id) }}"><i class="fi-rs-heart"></i></a>
                                ...
                                <div class="product-cart-wrap hover-up">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1">
                                            ...
                                            <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="{{ route('wishlist.store',$product->id) }}" tabindex="0"><i class="fi-rs-heart"></i></a>
