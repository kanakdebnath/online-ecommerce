        ...
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h6 class="text-body"><a href="{{ route('clearAllCart') }}" class="text-muted"><i class="fi-rs-trash mr-5"></i>Clear Cart</a></h6>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="table-responsive shopping-summery">
                    <table class="table table-wishlist">
                        ...
                        <tbody>
                            ...
                            <tr class="pt-30">
                                <td class="image product-thumbnail pt-40"><img src="{{ $product->attributes['photo'] }}" alt="#"></td>
                                <td class="product-des product-name">
                                    <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="{{ route('product-details',$product->id) }}">{{ $product->name }}</a></h6>
                                </td>
                                ...
                                <td class="action text-center" data-title="Remove"><a href="{{ route('cart.delete',$product->id) }}" class="text-body"><i class="fi-rs-trash"></i></a></td>
                            </tr>
